...
//     gridClass: "lg:col-span-2  lg:row-span-1 lg:col-start-1 lg:row-start-4",
//   },
...
//     gridClass: "lg:col-span-2  lg:row-span-1 lg:col-start-3 lg:row-start-4",
//   },
//   {
//     id: 4,
//     title: "Trading",
...
//     gridClass: "lg:col-span-2  lg:row-span-1 lg:col-start-5 lg:row-start-4",
//   },
//   {
//     id: 5,
//     title: "Apple",
...
//     gridClass: "lg:col-span-2  lg:row-span-1 lg:col-start-7 lg:row-start-4",
//   },
//   {
//     id: 6,
//     title: "Gemini",
...
const VideoCard = ({ video, setSelectedVideo }) => {
  ...
  return (
    ...
    >
      ...
      {/* OVERLAY */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#00181C]/95 via-[#00181C]/20 to-transparent" />

      {/* PINK GLOW */}
      <div className="absolute -right-16 -top-16 h-40 w-40 rounded-full bg-[#FF4E75]/20 blur-3xl" />
